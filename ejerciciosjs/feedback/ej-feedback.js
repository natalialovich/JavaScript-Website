...
function parar() {
  ...
  //y cambia el texto del botón aterrizar
  btnVolar.disabled = true;
  btnParar.disabled = true;
  btnParar.textContent = "Aterrizando!"
  // función a realizar durante el intervalo
  function aterrizar(){
    //guarda en una variable los datos de posición del elemento ardilla 
    let posicion = ardilla.getBoundingClientRect()
    //cuando la ardilla llega a la posición especificada, se muestra la ardilla2
